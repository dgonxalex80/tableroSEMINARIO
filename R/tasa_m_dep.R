...
sex11$tasam <- as.numeric(sex11$tasam, na.rm = TRUE)
sex12$tasam <- as.numeric(sex12$tasam, na.rm = TRUE)
sex13$tasam <- as.numeric(sex13$tasam, na.rm = TRUE)
sex14$tasam <- as.numeric(sex14$tasam, na.rm = TRUE)
sex15$tasam <- as.numeric(sex15$tasam, na.rm = TRUE)
sex16$tasam <- as.numeric(sex16$tasam, na.rm = TRUE)
sex17$tasam <- as.numeric(sex17$tasam, na.rm = TRUE)
sex18$tasam <- as.numeric(sex18$tasam, na.rm = TRUE)
sex19$tasam <- as.numeric(sex19$tasam, na.rm = TRUE)
sex20$tasam <- as.numeric(sex20$tasam, na.rm = TRUE)
sex21$tasam <- as.numeric(sex21$tasam, na.rm = TRUE)
sex22$tasam <- as.numeric(sex22$tasam, na.rm = TRUE)




tasa11 <- tapply(sex11$tasam, sex11$cdep, sum) ;dep11 <- rownames(tasa11)
tasa12 <- tapply(sex12$tasam, sex12$cdep, sum) ;dep12 <- rownames(tasa12)
tasa13 <- tapply(sex13$tasam, sex13$cdep, sum) ;dep13 <- rownames(tasa13) 
tasa14 <- tapply(sex14$tasam, sex14$cdep, sum) ;dep14 <- rownames(tasa14)
tasa15 <- tapply(sex15$tasam, sex15$cdep, sum) ;dep15 <- rownames(tasa15)
tasa16 <- tapply(sex16$tasam, sex16$cdep, sum) ;dep16 <- rownames(tasa16)
tasa17 <- tapply(sex17$tasam, sex17$cdep, sum) ;dep17 <- rownames(tasa17)
tasa18 <- tapply(sex18$tasam, sex18$cdep, sum) ;dep18 <- rownames(tasa18)
tasa19 <- tapply(sex19$tasam, sex19$cdep, sum) ;dep19 <- rownames(tasa19)
tasa20 <- tapply(sex20$tasam, sex20$cdep, sum) ;dep20 <- rownames(tasa20)
tasa21 <- tapply(sex21$tasam, sex21$cdep, sum) ;dep21 <- rownames(tasa21)
tasa22 <- tapply(sex22$tasam, sex22$cdep, sum) ;dep22 <- rownames(tasa22)
...
write_csv(dptos, "data/data_tasa_m.csv")
